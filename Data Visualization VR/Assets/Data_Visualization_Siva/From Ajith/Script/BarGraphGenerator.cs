...
namespace BarGraph.VittorCloud
{
    ...
    public class BarGraphDataSet
    {
       ...
       // public static XYBarValues[] ListOfBars;
    ...
    public class BarGraphGenerator : MonoBehaviour
    {
        ...
        public void Update()
        {
            //if(!ontriger.isclicked)
            //{
               if (ontriger.selectedobj != null)
                {
                    str = ontriger.selectedobj;
                    StartCoroutine(test2());
                    //ontriger.isclicked = true;
                }
            //}
        ...
        //    for(int i=0;i<19;i++)
        //    {
        //        strarray[i] = ListOfDataSet[i].GroupName;
        ...
        public void test3(string sm)
        {
            string sv = sm;
                
                    //if ((int)graphAnimation == 1 || (int)graphAnimation == 3)
                    //    StartCoroutine(CreateBarsWithAnimTypeOneOrThree(sv));
                    //else
                    //    CreateBarsWithAnimTypeTwo();
